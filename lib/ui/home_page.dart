  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          'Abdulrhman Samir — Flutter Developer',
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/backgound_pic/background_pic.jpg'),
            fit: BoxFit.cover,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 12),
                        Text('Feel free to reach me at:',style: TextStyle(color: Colors.white),),
                        SizedBox(height: 8),
                        SelectableText(
